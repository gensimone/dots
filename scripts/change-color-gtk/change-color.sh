...
# Removing hashes (pywal integration)
BG=$(remove_hash $BG)
BTN_BG=$(remove_hash $BTN_BG)
BTN_FG=$(remove_hash $BTN_FG)
FG=$(remove_hash $FG)
HDR_BTN_BG=$(remove_hash $HDR_BTN_BG)
HDR_BTN_FG=$(remove_hash $HDR_BTN_FG)
HDR_BG=$(remove_hash $HDR_BG)
HDR_FG=$(remove_hash $HDR_FG)
SEL_BG=$(remove_hash $SEL_BG)
SEL_FG=$(remove_hash $SEL_FG)
TXT_BG=$(remove_hash $TXT_BG)
TXT_FG=$(remove_hash $TXT_FG)
WM_BORDER_FOCUS=$(remove_hash $WM_BORDER_FOCUS)
WM_BORDER_UNFOCUS=$(remove_hash $WM_BORDER_UNFOCUS)
